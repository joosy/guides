...
At this stage we got our Rails backend, Resources and two pages with actual data from server. Now, we go further with [elements, events and filters](/guides/1.1/en/blog/elements-events-and-filters.html).
